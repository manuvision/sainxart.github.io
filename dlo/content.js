...
export const COPY = {
  fr: {
    ...
    sceneRole: 'bouteille 3D interactive', close: 'Fermer',
...
<p class="model-version">Données de référence : 2023 · Sources consultées le 9 septembre 2026</p>`,
  ...
  en: {
    ...
    sceneRole: 'interactive 3D bottle', close: 'Close',
