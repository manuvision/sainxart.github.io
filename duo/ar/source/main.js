...
import { loadOfficialLighting } from '../../source/official-lighting.js';
import { createPhone, W, H } from '../../source/phone.js';
...
async function start() {
  ...
  let raf=0,lastTime=performance.now(),loopTime=0,loopPlaying=!reduced;
  let dirty=true;
  ...
  window.duo={getState:()=>({fold,target,yaw,pitch,dragging,loopPlaying,loopTime,width:stage.clientWidth,height:stage.clientHeight,triangles:renderer.info.render.triangles,calls:renderer.info.render.calls})};
}
